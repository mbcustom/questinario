...
public class AdministracaoFragment extends Fragment {
    ...
    private AdministracaoViewModel administracaoViewModel;
   ...
   // private Questao questao;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        administracaoViewModel =
                ViewModelProviders.of( this ).get( AdministracaoViewModel.class );
        View root = inflater.inflate( R.layout.fragment_home, container, false );

        Intent intent = new Intent(getActivity(), QuestaoActivity.class);

        intent.putExtra( "classificacao", "ADMINITRACAO PUBLICA" );
