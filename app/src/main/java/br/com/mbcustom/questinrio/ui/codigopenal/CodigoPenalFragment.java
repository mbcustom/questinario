...
public class CodigoPenalFragment extends Fragment {


    int i=0;

    private CodigoPenalViewModel codigoPenalViewModel;
   ...
   // private Questao questao;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        codigoPenalViewModel =
                ViewModelProviders.of( this ).get( CodigoPenalViewModel.class );
        View root = inflater.inflate( R.layout.fragment_home, container, false );

        Intent intent = new Intent(getActivity(), QuestaoActivity.class);

        intent.putExtra( "classificacao", "CODIGO PENAL" );
