...
public class ConstituicaoFederalFragment extends Fragment {


    int i=0;

    private ConstituicaoFederalViewModel cfpmViewModel;
   ...
   // private Questao questao;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        cfpmViewModel =
                ViewModelProviders.of( this ).get( ConstituicaoFederalViewModel.class );
        View root = inflater.inflate( R.layout.fragment_home, container, false );

        Intent intent = new Intent(getActivity(), QuestaoActivity.class);

        intent.putExtra( "classificacao", "CONSTITUICAO FEDERAL (PM)" );
