...
public class LeiDeTorturaFragment extends Fragment {


    int i=0;

    private LeiDeTorturaViewModel leiDeTorturaViewModel;
   ...
   // private Questao questao;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        leiDeTorturaViewModel =
                ViewModelProviders.of( this ).get( LeiDeTorturaViewModel.class );
        View root = inflater.inflate( R.layout.fragment_home, container, false );

        Intent intent = new Intent(getActivity(), QuestaoActivity.class);

        intent.putExtra( "classificacao", "LEI DE TORTURA" );
