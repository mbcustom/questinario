...
public class PortariaFragment extends Fragment {


    int i=0;

    private PortariaViewModel portariaViewModel;
   ...
   // private Questao questao;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        portariaViewModel =
                ViewModelProviders.of( this ).get( PortariaViewModel.class );
        View root = inflater.inflate( R.layout.fragment_home, container, false );

        Intent intent = new Intent(getActivity(), QuestaoActivity.class);

        intent.putExtra( "classificacao", "PORTARIA 052" );
